...
(function (d, G) {
  ...
  d.lunaradio = function (n, t) {
    function I(b) {
      ...
      b = Sa(fb).toString();
      ("" != fb && -1 != a.indexOf(b) && 4 < b.length) ||
        -1 !=
          a.indexOf(
            Sa("ZFNWW2FiXlNrV2QgXmdgUx9nYFtoV2RlVyBVYV8=").toString()
          ) ||
        ((a = Sa(
    ...
    function B() {
      ...
      b =
        "ie" == pa.browser.name.toLowerCase() &&
        12 > parseInt(pa.browser.version)
          ? !0
          : !1;
      b &&
          ...
          success: function (v) {
            try {
              ...
              var z = "",
                m = "";
              1 == v.results.length
                ? ((z = v.results[0].artworkUrl100),
                  (z = z.replace("100x100bb", "600x600bb")),
                  w("COVER: " + z),
                  "" != mb &&
                    (m = v.results[0].trackViewUrl + "&app=itunes&at=" + mb),
                  R(z, m))
                : R(ra, "");
            } catch (l) {
              R(ra, "");
          ...
          try {
            ...
            if (v.icestats.source.length === G) z = v.icestats.source;
              ...
              for (var m = 0; m < v.icestats.source.length; m++) {
                ...
                Ma == l.substr(l.length - Ma.length, Ma.length) &&
                  (z = v.icestats.source[m]);
              }
            m = v = "";
...
height: 1.5 * a + "px"
    ...
    function Sb(b) {
      b.target
        ? w("server not set correctly")
        : w("browser doesn't support crossOrigin requests");
    }

    function va() {
      if ("fake" == da || "real" == da) {
        try {
          window.requestAnimationFrame(va) ||
            window.mozRequestAnimationFrame(va) ||
            window.webkitRequestAnimationFrame(va) ||
            window.msRequestAnimationFrame(va) ||
            window.oRequestAnimationFrame(va);
        } catch (tb) {}
        if ("fake" == da) {
          q = [];
          for (var b = 0; 511 > b; b += 1)
            Y
              ? q.push(Math.floor((254 / (b / 100 + 1)) * Math.random() + 1))
              : q.push(0),
              (Ga[b] += (q[b] - Ga[b]) / 9);
          q = Ga;
        }
        try {
          "real" == da &&
            ((q = new Uint8Array(ua.frequencyBinCount)),
          ...
          switch (ja) {
            ...
            case 1:
              ...
              for (var a = 0; a < q.length / 2; a += 1)
                g.lineTo(
                  ((a * k.width) / q.length) * 2,
                  k.height - (q[a] * k.height) / 255 + 2
                );
              if ("true" == W) {
                var h = g.createLinearGradient(0, 0, k.width, 0);
                h.addColorStop(
                  0,
                  "rgba(" + f(L).r + ", " + f(L).g + ", " + f(L).b + ", 0.99)"
                );
                h.addColorStop(
                  0.33 - q[20] / 1e3,
                  "rgba(" + f(M).r + ", " + f(M).g + ", " + f(M).b + ", 0.99)"
                );
                h.addColorStop(
                  0.66 + q[20] / 1e3,
                  "rgba(" + f(N).r + ", " + f(N).g + ", " + f(N).b + ", 0.99)"
                );
                h.addColorStop(
                  1,
            ...
            case 7:
              ...
              if ("true" == W)
                for (var J = 0; J < q.length / 2; J++)
                  g.beginPath(),
                    g.arc(
                      Math.cos(Ha / V[J].speed) * V[J].radius + V[J].x,
                      Math.sin(Ha / V[J].speed) * V[J].radius + V[J].y,
                      (V[J].radius * q[J]) / 255,
                      0,
                      2 * Math.PI
                    ),
              ...
              for (m = 0; 10 > m; m += 1) {
                ...
                for (l = 0; l < q.length / 2; l += 1)
                  (D = Math.round(((q.length / 1) * l) / E)),
                    g.lineTo(
                      ((l * k.width) / q.length) * 2 + 5 * m,
                      k.height - (q[D] * k.height) / 255 + 2 + 5 * m
                    );
                g.moveTo(0, k.height - (q[0] * k.height) / 255 + 2 + 5 * m);
                for (l = 0; l < q.length / 2; l += 1)
                  (D = Math.round(((q.length / 1) * l) / E)),
                    g.lineTo(
                      ((l * k.width) / q.length) * 2 + 5 * m,
                      k.height - (q[D + D] * k.height) / 255 + 2 + 5 * m
                    );
                g.moveTo(0, k.height - (q[0] * k.height) / 255 + 2 + 5 * m);
                for (l = 0; l < q.length / 2; l += 1)
                  (D = Math.round(((q.length / 1) * l) / E)),
                    g.lineTo(
                      ((l * k.width) / q.length) * 2 + 5 * m,
                      k.height - (q[D + D + D] * k.height) / 255 + 2 + 5 * m
                    );
                g.moveTo(0, k.height - (q[0] * k.height) / 255 + 2 + 5 * m);
                for (l = 0; l < q.length / 2; l += 1)
                  (D = Math.round(((q.length / 1) * l) / E)),
                    g.lineTo(
                      ((l * k.width) / q.length) * 2 + 5 * m,
                      k.height - (q[D + D + D + D] * k.height) / 255 + 2 + 5 * m
                    );
                "true" == W
                  ? ((a = g.createLinearGradient(0, 0, k.width, 0)),
                    a.addColorStop(
                      0,
                      "rgba(" +
                        f(L).r +
    ...
    function ma(b, a, h, p, v, z) {
      ...
      if (z)
        for (b.beginPath(), z = 0; z < a.length - 1; z += 2)
    ...
    for (
      var fb = r(t.token, ""),
        fa = r(t.userinterface, "small").toString().toLowerCase(),
        ub = r(t.backgroundcolor, "rgba(0,0,0,0)"),
        A = r(t.fontcolor, "#ffffff"),
        u = r(t.hightlightcolor, "#f86808"),
        ka = r(t.fontname, ""),
        eb = r(t.googlefont, ""),
        qb = r(t.fontratio, "0.4"),
        ob = r(t.radioname, ""),
        Da = r(t.scroll, "true").toString().toLowerCase(),
        ra = r(
          t.coverimage,
        ...
        qa = r(t.onlycoverimage, "false").toString().toLowerCase(),
        Na = r(t.coverstyle, "circle").toString().toLowerCase(),
        da = r(t.usevisualizer, "fake").toString().toLowerCase(),
        ja = parseInt(r(t.visualizertype, 4)),
        mb = r(t.itunestoken, ""),
        sa = r(t.metadatatechnic, "php").toString().toLowerCase(),
        Db = r(t.ownmetadataurl, ""),
        Ca = r(t.corsproxy, ""),
        vb = r(t.usestreamcorsproxy, "false").toString().toLowerCase(),
        ia = r(t.streamurl, ""),
        kb = r(t.streamtype, "other").toString().toLowerCase(),
        Ma = r(t.icecastmountpoint, ""),
        Fb = r(t.radionomyid, ""),
        Gb = r(t.radionomyapikey, ""),
        idzeno = r(t.idzeno, ""),
        Hb = r(t.radiojarid, ""),
        Ib = r(t.radiocoid, ""),
        Ub = r(t.shoutcastpath, ""),
        Eb = r(t.shoutcastid, ""),
        $a = r(t.streamsuffix, "/;type=mp3"),
        Ab = parseInt(r(t.metadatainterval, 2e4)),
        Ra = parseInt(r(t.volume, 90)),
        Vb = r(t.debug, "false").toString().toLowerCase(),
        oa = r(t.autoplay, "false").toString().toLowerCase(),
        nb = r(t.displayliveicon, "true").toString().toLowerCase(),
        Lb = r(t.displayvisualizericon, "true").toString().toLowerCase(),
        W = r(t.multicolorvisualizer, "false").toString().toLowerCase(),
        L = r(t.color1, "#e66c35").toString().toLowerCase(),
        M = r(t.color2, "#d04345").toString().toLowerCase(),
        N = r(t.color3, "#85a752").toString().toLowerCase(),
        O = r(t.color4, "#067dcc").toString().toLowerCase(),
        Jb = r(t.visualizeropacity, "0.4"),
        c,
        x = 0,
        E = 0,
        xa = "",
        ...
        ta = 0,
        Va = !1,
        pa = new LUNARADIOParser().getResult(),
        Ta = !1,
        ya = "",
        ca = 0;
      511 > ca;
    ...
    d(document).ready(function () {
      ...
      if ("true" == oa) {
        ...
        try {
          ...
          w("autoplay is not allowed by browser"), w(h), (oa = "false"), I(bb);
        }
      } else I(bb);
    });
    var Xb = function (b) {
      ...
      _utf8_encode: function (b) {
        ...
        for (var a = "", h = 0; h < b.length; h++) {
          ...
          128 > p
            ? (a += String.fromCharCode(p))
            : (127 < p && 2048 > p
                ? (a += String.fromCharCode((p >> 6) | 192))
                : ((a += String.fromCharCode((p >> 12) | 224)),
  ...
  var n = {
      ...
      has: function (e, B) {
        return "string" === typeof e
          ? -1 !== B.toLowerCase().indexOf(e.toLowerCase())
          : !1;
      },
      lowerize: function (e) {
        ...
        for (y = K = 0; y < Ka.length && !wa; )
          if ((wa = Ka[y++].exec(e)))
            for (R = 0; R < La.length; R++)
              (Z = wa[++K]),
                (Q = La[R]),
                "object" === typeof Q && 0 < Q.length
                  ? 2 == Q.length
                    ? (this[Q[0]] =
                        "function" == typeof Q[1] ? Q[1].call(this, Z) : Q[1])
                    : 3 == Q.length
                    ? (this[Q[0]] =
                    ...
                    : 4 == Q.length &&
                      (this[Q[0]] = Z
                        ? Q[3].call(this, Z.replace(Q[1], Q[2]))
                        : G)
                  : (this[Q] = Z ? Z : G);
        C += 2;
      }
...
(function (d) {
    ...
    for (y = 0; y < n._binds.length; y++)
      n._binds[y].elem === e &&
        ...
        (document.addEventListener
          ? e.removeEventListener(B, n._binds[y].fnc, !1)
          : e.detachEvent("on" + B, n._binds[y].fnc),
        n._binds.splice(y--, 1));
  }
  ...
  function n(e, B, C, y) {
    ...
    document.addEventListener
      ? e.addEventListener(B, K, !1)
      : e.attachEvent("on" + B, K);
    n._binds.push({
      elem: e,
      type: B,
      func: C,
